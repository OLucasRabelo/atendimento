...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { document: @visitor.document, localuser: @visitor.localuser, name: @visitor.name, sector: @visitor.sector, telefone: @visitor.telefone } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { document: @visitor.document, localuser: @visitor.localuser, name: @visitor.name, sector: @visitor.sector, telefone: @visitor.telefone } }
